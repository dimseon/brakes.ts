...
class Brakes extends EventEmitter {
    constructor(func, opts) {
        ...
        this['_stats'] = new Stats_1.Stats(opts);
    ...
    */
    ...
    exec() {
        ...
        return bluebird_1.Promise.reject(new Error(consts.NO_FUNCTION));
    }
    _close() {
        this['_circuitOpen'] = false;
    ...
    */
    ...
    _timeoutHandler(runTime, _error, execGeneration) {
        if (execGeneration === this['_circuitGeneration']) {
            this['_stats'].timeout(runTime);
        }
    }
    _failureHandler(runTime, _error, execGeneration) {
        if (execGeneration === this['_circuitGeneration']) {
            this['_stats'].failure(runTime);
        }
    }
    subCircuit(service, fallback, options) {
        return new Circuit(this, service, fallback, options);
    }
}
exports.Brakes = Brakes;
