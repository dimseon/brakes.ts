...
const CircuitBrokenError_1 = require("./CircuitBrokenError");
...
class Circuit extends EventEmitter {
    ...
    exec() {
        ...
        if (this['_brakes']._circuitOpen) {
            ...
            return bluebird_1.default.reject(new CircuitBrokenError_1.CircuitBrokenError(this['_brakes'].name, this['_brakes']._stats._totals, this['_brakes']._opts.threshold));
        }
